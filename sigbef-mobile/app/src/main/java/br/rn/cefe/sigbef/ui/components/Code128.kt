...
/**
 * Code 128B — a mesma simbologia que o desktop usa (sigbef/barcode_util.py).
 *
 * Tabela e algoritmo idênticos ao Python, para que o leitor do balcão leia
 * o cartão do celular exatamente como lê o cartão impresso.
 */
internal object Code128 {
    ...
    internal fun valores(texto: String): List<Int> {
